...
<template>
    <div>
        ...
        <Descriptions
            class="mb10 mt30"
            title="生产环境依赖 dependencies"
            :column="{ md: 2, lg: 3, xl: 4 }"
        >
            <DescriptionsItem
                :label="dependency"
                v-for="(version, dependency) in pkg.dependencies"
                :key="dependency"
            >
        ...
        <p class="u-tip mb10">
            所有组件 <Tag color="magenta">CSS</Tag> 样式均使用
            <Tag color="magenta">box-sizing: border-box;</Tag> 模式！
        </p>
        <p class="u-tip mb10">
            目前共有 <Tag color="magenta">{{ sum }}</Tag> 个常用基础
            <Tag color="magenta">UI</Tag> 组件，以及
            <Tag color="magenta">11</Tag>
            个常用工具函数，并且持续探索更新中...！
        </p>
        ...
        <ul class="m-list">
            ...
            <li class="u-tip mb10">
                <Tag color="geekblue">rafTimeout</Tag>: 使用
                requestAnimationFrame 实现的定时器函数，等效替代 (setTimeout 和
                setInterval)！
            </li>
            <li class="u-tip mb10">
                <Tag color="geekblue">cancelRaf</Tag>: 用于取消 rafTimeout
                函数！
            </li>
            <li class="u-tip mb10">
                <Tag color="geekblue">throttle</Tag>: 使用 rafTimeout
                实现的节流函数！
            </li>
            <li class="u-tip mb10">
                <Tag color="geekblue">debounce</Tag>: 使用 rafTimeout
                实现的防抖函数！
            </li>
            <li class="u-tip mb10">
                <Tag color="geekblue">add</Tag>: 消除js加减精度问题的加法函数！
            </li>
            <li class="u-tip mb10">
            ...
            <li class="u-tip mb10">
                <Tag color="geekblue">formatNumber</Tag>: 数字格式化函数！
            </li>
            <li class="u-tip mb10">
                <Tag color="geekblue">toggleDark</Tag>: 一键切换暗黑模式函数！
            </li>
        </ul>
        <Collapse
            lang="vue3"
